...
(function (window) {
  ...
  mixitup.use = function (extension) {
    mixitup.Base.prototype.callActions.call(mixitup, 'beforeUse', arguments); // Call the extension's factory function, passing
  ...
  /** @lends mixitup.Mixer */
  {
    ...
    getTweenData: function (operation) {
      ...
      for (i = 0; target = operation.show[i]; i++) {
        ...
        posData.tweenData = new mixitup.StyleData(); // Process x and y
